...
public class ProductService {
    ...
    public Product create(String sku, String name, String category, String unit, String imageUrl,
    ...
    public Product update(Long id, String name, String category, String unit, String imageUrl,
